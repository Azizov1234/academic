...
export default function SuperadminAdminsPage() {
  const users = [
    { name: "Sardor Alimov", email: "sardor@example.com", phone: "+998 90 123 45 67", role: "Admin" },
    { name: "Malika Yusupova", email: "malika@example.com", phone: "+998 90 765 43 21", role: "Admin" },
    { name: "Aziz Rakhimov", email: "aziz@example.com", phone: "+998 99 987 65 43", role: "Admin" }
  ];
      ...
      <Card>
        <CardHeader>
          <div className="flex justify-between items-center">
            <CardTitle>Barcha Admins</CardTitle>
